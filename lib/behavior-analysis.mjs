...
const BEHAVIOR_ROWS = [
  ...
  {
    key: "recipe-started",
    label: "Recipe creation started",
    kind: "Intent",
    events: ["recipe_create_started", "start_draft_imported"]
  },
  {
    key: "recipe-completed",
    label: "Recipe created or updated",
    kind: "Conversion",
    events: ["recipe_create_completed", "recipe_updated"]
  },
  {
    key: "pet-created",
    label: "Pet created",
  ...
  {
    key: "premium-selected",
    label: "Premium plan selected",
    kind: "Intent",
  ...
  },
  {
    ...
    kind: "Intent",
    events: ["premium_upgrade_started", "checkout_started"]
  },
  {
    key: "premium-completed",
    label: "Premium upgrade completed",
    kind: "Conversion",
    events: ["premium_upgrade_completed", "checkout_completed"]
  },
  {
    key: "friction",
    label: "Bug or frustration signal",
    kind: "Friction",
    events: ["$rageclick", "checkout_error", "recipe_create_error", "error_shown"]
  }
];
